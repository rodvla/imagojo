...
; Programa Imagojo
; AutoIt 3.3.61
; Creado :12/11/10   Modificado: 27/11/11 
...
Case $Button2; Crear Dicom
	...
	If $PID0 Then
		;SplashTextOn("Guardar archivo", "Guardando archivo", 300, 150, -1, -1)
		$Formaa = GUICreate("", 300, 150, -1, -1, $WS_EX_TOPMOST)
		$Progress1 = GUICtrlCreateProgress(48, 56, 153, 20)
		$Label1 = GUICtrlCreateLabel("Guardando archivo, espere..", 24, 24, 213, 17)
		GUICtrlSetFont(-1, 8, 800, 0, "MS Sans Serif")
		GUISetState(@SW_SHOW)
		GUICtrlSetData ($Progress1,10)
