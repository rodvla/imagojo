...
Global $MedRef, $PaintEst, $Asterisco, $Institucion, $Fecha_contenido, $Arch_pdf, $Arch_video
...
$Dir_jpg=IniRead("IMAGOJO.ini", "Estación", "DirJpg", '')
$Dir_video=IniRead("IMAGOJO.ini", "Estación", "DirVideo", '')
$Dir_pdf=IniRead("IMAGOJO.ini", "Estación", "DirPdf", '')
...
Case $Consultar;Consulta a la base de datos para ver si ya existe el paciente, y en caso afirmativo trae los datos
	...
	If $Ced_pa then
		$ced_paPrima=$Ced_pa
		if $ced_paPrima=">" or $ced_paPrima="=" or $ced_paPrima="<" or $ced_paPrima="&" or $ced_paPrima=";" or $ced_paPrima="?" or $ced_paPrima="/" or $ced_paPrima="""" or $ced_paPrima="\" or $ced_paPrima="," then $ced_paPrima='lkjlkj32'
	...
	Else 
		$ape_paPrima=$Ape_pa
		If $ape_paPrima='' or $ape_paPrima="=" or $ape_paPrima=">" or $ape_paPrima="<" or $ape_paPrima="&" or $ape_paPrima=";"or $ape_paPrima="?"  or $ape_paPrima="/" or $ape_paPrima="""" or $ape_paPrima="\" or $ape_paPrima="," Then $ape_paPrima='lkjlkj32'
	...
	If $file = -1 Then
    SplashOff()
	MsgBox(0, "Error", "El valor ingresado contiene caracteres no permitidos")
	GUIDelete ($form2)
	Call ("Form"&$Op)
	EndIf
	$Query = FileRead($file)
...
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$InputDir_video = GUICtrlCreateInput($Dir_video, 225, 168, 409, 22)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Button5 = GUICtrlCreateButton("Explorar", 641, 166, 57, 25, 0)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Label5 = GUICtrlCreateLabel("Ruta documentos pdf", 102, 213, 107, 18)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$InputDir_pdf = GUICtrlCreateInput($Dir_pdf, 213, 208, 417, 22)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
...
Func Form21()
#Region ### START Koda GUI section ### Form=l:\IMAGOJO\software bajado\programacion\koda 1.7.0.1\forms\fotocomentar.kxf
$Form21 = GUICreate("Archivo "&$Arch_pdf&" para crear DICOM para paciente: "&$Nom_paciente,801, 474, -1, -1, $WS_SIZEBOX + $WS_SYSMENU)
...
$Form24 = GUICreate("Archivo de video para crear DICOM para paciente: "&$Nom_paciente,801, 474, -1, -1, $WS_SIZEBOX + $WS_SYSMENU)
...
$Label4 = GUICtrlCreateLabel("Comentario sobre el paciente:", 17, 32, 143, 17)
$Input4 = GUICtrlCreateInput("", 165, 27, 265, 21)
$Label1 = GUICtrlCreateLabel("Descripción del video:", 25, 56, 134, 17)
$Input1 = GUICtrlCreateInput("", 165, 51, 622, 21)
$Button1 = GUICtrlCreateButton("Crear", 710, 80, 75, 25, 0)
$Button3 = GUICtrlCreateButton("Previsualizar", 16, 80, 75, 25, 0)
$Button2 = GUICtrlCreateButton("Cancelar", 16, 408, 75, 25, 0)
