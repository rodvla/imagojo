...
Global $MedRef, $PaintEst, $Asterisco=1, $Institucion

;LECTURA DEL ARCHIVO DE CONFIGURACIÓN IMAGOJO.ini
$ALIAS1=IniRead("IMAGOJO.ini", "Comunicaciones", "Alias1", 'xxCharrua')
$AE1=IniRead("IMAGOJO.ini", "Comunicaciones", "AE1", 'xxCHARRUAPACS')
$IP1=IniRead("IMAGOJO.ini", "Comunicaciones", "IP1", 'xxlocalhost')
$PUERTO1=IniRead("IMAGOJO.ini", "Comunicaciones", "PUERTO1", 'xx11112')
;$ALIAS2=IniRead("IMAGOJO.ini", "Comunicaciones", "Alias2", 'xxESTACIONX')
$AE2=IniRead("IMAGOJO.ini", "Comunicaciones", "AE2", 'xxESTACIONX')
;$IP2=IniRead("IMAGOJO.ini", "Comunicaciones", "IP2", 'xxlocalhost')
...
$visorweb=IniRead("IMAGOJO.ini", "Directorios", "Visorweb", 'C:\IMAGOJO\GoogleChromePortable\GoogleChromePortable.exe')
$Estacion=IniRead("IMAGOJO.ini", "Estación", "Estación", 'Workstation')
$Institucion=IniRead("IMAGOJO.ini", "Estación", "Institución", 'Institución')
$RutaCaptura=IniRead("IMAGOJO.ini", "Estación", "RutaCaptura", '')
$Dir_jpg=IniRead("IMAGOJO.ini", "Estación", "RutaJpg", '')
$Ruta_video=IniRead("IMAGOJO.ini", "Estación", "RutaVideo", '')
$Ruta_pdf=IniRead("IMAGOJO.ini", "Estación", "RutaPdf", '')
$NProgCaptura=IniRead("IMAGOJO.ini", "Estación", "NProgCaptura", '')
$Asterisco=IniRead("IMAGOJO.ini", "Estación", "* en Consultar", '1')
...
$Ruta_Dcm= IniRead("IMAGOJO.ini", "Directorios", "Ruta_Dcm", 'C:\IMAGOJO\DCM')
...
$Form1= GUICreate("IMAGOJO: Principal                              "&$Institucion, 801, 451, $X_vent, $Y_vent)
...
$Label2 = GUICtrlCreateLabel("Servidor:", 597, 360+$k, 164, 20)
;GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
$Button6 = GUICtrlCreateButton("Cerrar Sesión", 32, 363+$k, 75, 25, 0)
$Label3 = GUICtrlCreateLabel($Servidor, 597, 377+$k, 164, 20)
;GUICtrlSetFont(-1, 10, 800, 0, "MS Sans Serif")
...
$y=18	
	...
	$Label6 = GUICtrlCreateLabel("Estación : "&$Estacion, 86+$x, 152+$y, 154, 21)
	GUICtrlSetFont(-1, 11, 400, 0, "Arial")
	...
	GuiCtrlCreateLabel(" ", 755, 373+$k, 10, 7)
...
Case $Button4;Visualizador Editor synedra View Personal
	...
	If ProcessExists("synedraViewPersonal.exe") Then 
		...
		If $state=13 Then
		SplashTextOn ("Abrir Visor Editor", "Ya hay una instancia minimizada de Synedra ejecutándose", 250,100)
		Sleep (1500)
		SplashOff()
		EndIf
	else
...
Case $Button5;Visualizador Web
	...
	If ProcessExists("FirefoxPortable.exe") Then 
		WinActivate("Mozilla", "")
		SplashTextOn ("Abrir Viualizador Web", "Ya está en ejecución", 250,100)
		Sleep (1500)
		SplashOff()
	ElseIf ProcessExists("GoogleChromePortable.exe") Then
		...
		SplashTextOn ("Abrir Viualizador Web", "Se inició proceso", 250,100)
		Sleep (1000)
...
$Form2 = GUICreate("IMAGOJO: Paciente                              "&$Institucion, 801, 451, $X_vent, $Y_vent, $WS_CAPTION)
GUISetBkColor(0xF9FCFF)
...
Case $Consultar;Consulta a la base de datos para ver si ya existe el paciente, y en caso afirmativo trae los datos
	...
	If $Ced_pa then 
		...
		If $asterisco Then
		RunWait( @comspec & " /c dcmqr -L "&$AE2&":"&$PUERTO2&" "&$AE1&"@"&$IpPuertoServidor & " -q00100020="&$Ced_pa&"* -r 00100030 -r 00100010 -r 00100040 > " & @TempDir & "\IMAGOJOQuery.dat",$dir_trab,@SW_HIDE);consulta por id paciente
		Else
		RunWait( @comspec & " /c dcmqr -L "&$AE2&":"&$PUERTO2&" "&$AE1&"@"&$IpPuertoServidor & " -q00100020="&$Ced_pa&" -r 00100030 -r 00100010 -r 00100040 > " & @TempDir & "\IMAGOJOQuery.dat",$dir_trab,@SW_HIDE);consulta por id paciente
		EndIf
	...
	Else 
		...
		If $asterisco Then
		RunWait( @comspec & " /c dcmqr -L "&$AE2&":"&$PUERTO2&" "&$AE1&"@"&$IpPuertoServidor & " -q00100010="&$Ape_pa&"* -r 00100030 -r 00100020 -r 00100040 > " & @TempDir & "\IMAGOJOQuery.dat",$dir_trab,@SW_HIDE);consulta por apellido
		Else
		RunWait( @comspec & " /c dcmqr -L "&$AE2&":"&$PUERTO2&" "&$AE1&"@"&$IpPuertoServidor & " -q00100010="&$Ape_pa&" -r 00100030 -r 00100020 -r 00100040 > " & @TempDir & "\IMAGOJOQuery.dat",$dir_trab,@SW_HIDE);consulta por apellido
		EndIf
	;RunWait( @comspec & " /c dcmecho "&$AE1&"@"&$IpPuertoServidor & " > " & @TempDir & "\ECO.log",$dir_trab,@SW_HIDE)
...
$Label3 = GUICtrlCreateLabel("Técnico de Referencia:", 460, 6, 113, 17)
...
SplashOff()
$Form6 = GUICreate("IMAGOJO: Configuración                              "&$Institucion, 801, 451, $X_vent, $Y_vent)
...
#Region ### START Koda GUI section ### Form=C:\IMAGOJO\koda 1.7.0.1\Forms\ConfiguracionTab.kxf
SplashOff()
$Form10 = GUICreate("IMAGOJO: Configuración                              "&$Institucion, 801, 451, $X_vent, $Y_vent)
$PageControl1 = GUICtrlCreateTab(8, 8, 780, 352)
GUICtrlSetResizing(-1, $GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$TabSheet1 = GUICtrlCreateTabItem("Estación")
$inputRutaCaptura = GUICtrlCreateInput($RutaCaptura, 216, 88, 417, 22)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Label1 = GUICtrlCreateLabel("Programa de captura", 102, 93, 105, 18)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Button2 = GUICtrlCreateButton("Explorar", 640, 86, 57, 25, 0)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
...
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$InputDir_jpg = GUICtrlCreateInput($Dir_jpg, 201, 128, 433, 22)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Label4 = GUICtrlCreateLabel("Ruta imagenes jpg", 102, 133, 92, 18)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Button3 = GUICtrlCreateButton("Explorar", 641, 126, 57, 25, 0)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Label3 = GUICtrlCreateLabel("Ruta videos mpeg, mpg", 102, 173, 116, 18)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$InputRuta_video = GUICtrlCreateInput($Ruta_video, 225, 168, 409, 22)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Button5 = GUICtrlCreateButton("Explorar", 641, 166, 57, 25, 0)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Label5 = GUICtrlCreateLabel("Ruta documentos pdf", 102, 213, 107, 18)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$InputRuta_pdf = GUICtrlCreateInput($Ruta_pdf, 213, 208, 417, 22)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Button6 = GUICtrlCreateButton("Explorar", 637, 206, 57, 25, 0)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Checkbox1 = GUICtrlCreateCheckbox("Insertar un  comodín (*) en la consulta de pacientes", 112, 258, 273, 25)
$Label6 = GUICtrlCreateLabel("Nombe de la institución", 359, 53, 114, 18)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$InputInstitucion = GUICtrlCreateInput($Institucion, 481, 48, 249, 22)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Checkbox2 = GUICtrlCreateCheckbox("Ocultar diálogos al enviar DICOM", 467, 258, 193, 25)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
...
Case $Button1;ok
	...
	$Ruta_video=GUICtrlRead($inputRuta_video)
	$Ruta_pdf=GUICtrlRead($inputRuta_pdf)
	if $RutaCaptura then
	...
	IniWrite($Ruta_IMAGOJO&"\IMAGOJO.ini", "Estación", "RutaJpg", $Dir_jpg)
	IniWrite($Ruta_IMAGOJO&"\IMAGOJO.ini", "Estación", "Estación", $Estacion)
	IniWrite($Ruta_IMAGOJO&"\IMAGOJO.ini", "Estación", "RutaVideo", $Ruta_video)
	IniWrite($Ruta_IMAGOJO&"\IMAGOJO.ini", "Estación", "RutaPdf", $Ruta_pdf)
...
$Form8 = GUICreate("IMAGOJO: Creación DICOM                              "&$Institucion, 801, 451, $X_vent, $Y_vent)
GUISetBkColor(0xF9FCFF)
If $EstadoServ = "Activo" Then $Pic1 = GUICtrlCreatePic($Ruta_IMAGOJO&"\Lib\Gui\bandacolorV.gif", 0, 0, 801, 49)
If $EstadoServ = "Inactivo" Then $Pic1 = GUICtrlCreatePic($Ruta_IMAGOJO&"\Lib\Gui\bandacolor.gif", 0, 0, 801, 49)
...
$var = FileOpenDialog($message, $Ruta_pdf, "Archivos Pdf (*.pdf)", 1 + 4 )
if @error = 1 then 
...
$var = FileOpenDialog($message, $Ruta_video, "Archivos de Video (*.mpg;*.mpeg)", 1 + 4 )
if @error = 1 then 
;		MsgBox(0, "ATENCIÓN", $form1,20)
;	Sleep (5000)
GUIDelete ($form1)
...
$Form50 = GUICreate("IMAGOJO: pulse en las imágenes para seleccionar", 802, 445, 143, 52)
$Pic1 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Amsler-ch.jpg", 32, 26, 150, 150 )
$Pic2 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Farnsworth15-ch.jpg", 229, 26, 150, 150 )
$Pic3 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Farnsworth100-ch.jpg", 424, 26, 150, 150 )
$Pic4 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Goldman-ch.jpg", 620, 26, 150, 150 )
$Pic5 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Munsell1-ch.jpg", 35, 218, 150, 150 )
$Pic6 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Munsell2-ch.jpg", 229, 218, 150, 150 )
$Pic7 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\PantallaTGC-ch.jpg", 424, 218, 150, 150 )
$Pic8 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Pelli-Robinson-ch.jpg", 620, 218, 150, 150 )
...
Case $Button4
	ClipPut($Nom_paciente);Coloca el nombre del paciente en el portapapeles
