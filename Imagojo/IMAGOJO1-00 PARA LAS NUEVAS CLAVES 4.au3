...
Global $MedRef, $PaintEst, $Asterisco, $Institucion, $Fecha_contenido, $Arch_pdf, $Arch_video, $Dpto, $Nro_registrosT, $Dir_ctsn
...
;directorio de trabajo de Ctsm.imj
$Dir_ctsn=IniRead("IMAGOJO.ini", "Directorios", "Ctsm", 'xx')
IF $Dir_ctsn='xx' THEN
	IniWrite("IMAGOJO.ini", "Directorios", "Ctsm", $Ruta_IMAGOJO&'\lib\')
...
$nombreU = IniRead($arch_ctsn, $usuario, "name", "0");se lee el usuario que es 15125556
	...
	EndIf
	If $nombreU<>"0" and $contrasenia <> '' then 
		$keyUs = IniRead($arch_ctsn, $usuario, "key", "0");HAY USUARIO SE PASA A VERIFICAR CONTRASEÑA			
