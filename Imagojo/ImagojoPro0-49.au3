...
;*********************************
;Tareas que faltan:
;Ver algún modo de sincronización de la hora de las estaciones con el servidor
...
GUICtrlSetData(-1, "Farnsworth 100|Farnsworth 15|Test de Amsler|1.Munsell separación|2.Munsell clasificación|Sensibilidad de constraste|Perimetría Goldman|Campo visual 2 ojos|Perímetría papel térmico", "estudios")
GUISetState()
