...
Global $RutaCaptura, $AE2, $IP2BORRADA, $PUERTO2, $ALIAS1, $AE1, $IP1, $PUERTO1, $OPSAL=1, $Debug=1
...
Global $Ruta_video, $form23, $form24, $form25, $BorrarEnvBORRADA, $Dir_trab, $Temp_log, $FormXX, $X_ventE=790, $Y_ventE=35
...
$MenuItem16 = GUICtrlCreateMenuItem("Ver equipos conectados en la red y tipos de imáges que generan", $MenuItem2)
...
Case $MenuItem15;Configurar estación
...
Case $MenuItem16;Ver equipos conectados y tipos de imágenes que generan
	...
	;ShellExecute(@TempDir & "\Equipos.txt")
