...
$Label1 = GUICtrlCreateLabel("Sesión: ", 112, 356, 44, 20)
GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
$Label13 = GUICtrlCreateLabel($usuario, 111, 375, 86, 17)
GUICtrlSetFont(-1, 8, 800, 0, "MS Sans Serif")

$Label2 = GUICtrlCreateLabel("Servidor:", 597, 356, 164, 20)
GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
$Button6 = GUICtrlCreateButton("Cerrar Sesión", 32, 376, 75, 25, 0)
$Label3 = GUICtrlCreateLabel($Servidor, 597, 380, 99, 20)
GUICtrlSetFont(-1, 8, 800, 0, "MS Sans Serif")
...
$Group2 = GUICtrlCreateGroup("", 24, 344, 313, 65)
GUICtrlCreateGroup("", -99, -99, 1, 1)
If $RutaCaptura Then
$Label10 = GUICtrlCreateLabel("Prog. de Captura:", 356, 356,120, 17)
GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
$Label11 = GUICtrlCreateLabel($NProgCaptura, 356, 380, 120, 17)
GUICtrlSetFont(-1, 10, 800, 0, "MS Sans Serif")
$Group3 = GUICtrlCreateGroup("", 336, 344, 209, 65)
GUICtrlCreateGroup("", -99, -99, 1, 1)
EndIf
$Group4 = GUICtrlCreateGroup("", 544, 344, 233, 65)
GUICtrlCreateGroup("", -99, -99, 1, 1)
	...
	GuiCtrlCreateLabel(" ", 705, 385, 10, 7)
...
#Region ### START Koda GUI section ### Form=C:\IMAGOJO\koda 1.7.0.1\Forms\ConfiguracionTab.kxf
SplashOff()
$Form10 = GUICreate("IMAGOJO: Configuración", 801, 451, $X_vent, $Y_vent)
$PageControl1 = GUICtrlCreateTab(8, 8, 780, 352)
GUICtrlSetResizing(-1, $GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$TabSheet1 = GUICtrlCreateTabItem("Estación")
$inputRutaCaptura = GUICtrlCreateInput($RutaCaptura, 256, 120, 345, 22)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Label1 = GUICtrlCreateLabel("Ruta del programa de Captura", 104, 128, 148, 18)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Button2 = GUICtrlCreateButton("Navegar", 608, 120, 81, 25, 0)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$inputEstacion = GUICtrlCreateInput($Estacion, 232, 48, 145, 22)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Label2 = GUICtrlCreateLabel("Nombe de esta estación:", 102, 51, 123, 18)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
...
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$InputDir_jpg = GUICtrlCreateInput($Dir_jpg, 201, 162, 345, 22)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Label4 = GUICtrlCreateLabel("Ruta imagenes jpg", 105, 162, 92, 18)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
$Button3 = GUICtrlCreateButton("Navegar", 553, 162, 81, 25, 0)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
...
$Form1_1_1 = GUICreate("IMAGOJO: Seleccionar Estudios en Papel", 802, 445, 143, 52)
$Pic1 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Amsler-ch.jpg", 32, 32, -1, -1 )
$Pic2 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Farnsworth15-ch.jpg", 237, 35, 145, 140 )
$Pic3 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Farnsworth100-ch.jpg", 416, 37, 145, 172 )
$Pic4 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Goldman-ch.jpg", 596, 43, 177, 140 )
$Pic5 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Munsell1-ch.jpg", 43, 209, 145, 172 )
$Pic6 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Munsell2-ch.jpg", 233, 211, 145, 172 )
$Pic7 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\PantallaTGC-ch.jpg", 415, 222, 145, 164 )
$Pic8 = GUICtrlCreatePic("C:\ImagojoInst\Estudios\Pelli-Robinson-ch.jpg", 615, 218, 145, 140 )
$Label1 = GUICtrlCreateLabel("Amsler", 88, 8, 41, 17)
GUICtrlSetFont(-1, 8, 800, 0, "MS Sans Serif")
$Label2 = GUICtrlCreateLabel("Farnsworth15", 267, 12, 80, 17)
GUICtrlSetFont(-1, 8, 800, 0, "MS Sans Serif")
$Label3 = GUICtrlCreateLabel("Farnsworth100", 435, 12, 87, 17)
GUICtrlSetFont(-1, 8, 800, 0, "MS Sans Serif")
$Label4 = GUICtrlCreateLabel("Farnsworth100", 646, 12, 87, 17)
GUICtrlSetFont(-1, 8, 800, 0, "MS Sans Serif")
GUISetState(@SW_SHOW)
#EndRegion ### END Koda GUI section ###
...
$Form50 = GUICreate("IMAGOJO:", 197, 165, $X_ventE, $Y_ventE, -1, $WS_EX_TOPMOST)$Label1 = GUICtrlCreateLabel("Estudio Seleccionado:", 16, 40, 110, 17)
...
GUISetState()
$Button1 = GUICtrlCreateButton("Transcribir Estudio", 48, 80, 97, 25, 0)
$Button2 = GUICtrlCreateButton("Guardar y crear dcm", 256, 80, 81, 25, 0)
...
;	MsgBox(0, "Atención", $X_ventE&" Y="&$Y_ventE,10)
	...
	If $estudioSel='Test de Amsler'Then
		...
		$Button1 = GUICtrlCreateButton("Transcribir Estudio", 256, 80, 97, 25, 0)
