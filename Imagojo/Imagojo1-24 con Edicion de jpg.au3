...
$Button4 = GUICtrlCreateButton("Editar con Paint", 236, 48, 99, 25, 0)
...
Case $Button3; Previsualizar
	ShellExecute($dir_trab&"\selecc.jpg")
Case $Button4; Editar con Paint
	SplashTextOn ("Iniciando Paint", "Una vez finalizada la edicion guarde el archivo sin cambiarle el nombre", 250,100)
	FileCopy($Ruta_jpg, $dir_trab&"\selecc.jpg",1)
	Sleep (3000)
	Run ( 'mspaint.EXE "C:\Imagojo\dcm4\bin\selecc.jpg"' )
	SplashOff ()
