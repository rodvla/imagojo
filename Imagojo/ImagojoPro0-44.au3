...
$MenuItem3 = GUICtrlCreateMenuItem("Acerca de", $MenuItem4)
	If $Ced_pa Then
	$Label4 = GUICtrlCreateLabel("Paciente: ", 78, 256, 69, 21)
	GUICtrlSetFont(-1, 11, 400, 0, "Arial")
	$Label5 = GUICtrlCreateLabel($Nom_pa &" "&$Ape_pa, 145, 257, 273, 22)
	GUICtrlSetFont(-1, 11, 800, 0, "Arial")
	$Label6 = GUICtrlCreateLabel("Estación : "&$Estacion, 78, 208, 154, 21)
	GUICtrlSetFont(-1, 11, 400, 0, "Arial")
	$Label7 = GUICtrlCreateLabel("ID Paciente:", 78, 289, 83, 21)
	GUICtrlSetFont(-1, 11, 400, 0, "Arial")
	$Label8 = GUICtrlCreateLabel("Fecha : "&@MDAY & "/" & @MON & "/" & @YEAR, 78, 179, 129, 21)
	GUICtrlSetFont(-1, 11, 400, 0, "Arial")
	$Label9 = GUICtrlCreateLabel($ced_pa, 165, 288, 273, 22)
	GUICtrlSetFont(-1, 11, 800, 0, "Arial")
