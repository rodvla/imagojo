...
$Pic1 = GUICtrlCreatePic($Ruta_ImagojoPro&"\ImagojoPro-presentacion.jpg", 0, 0, 726, 243)
...
;$Pic2 = GUICtrlCreatePic($Ruta_ImagojoPro&"\barrita1.jpg", 0, 335, 801,110)
...
$MenuItem3 = GUICtrlCreateMenuItem("Acerca de", $MenuItem4)
	...
	$Label5 = GUICtrlCreateLabel($Nom_pa &" "&$Ape_pa, 153, 201, 273, 22)
...
$Image1 = GUICtrlCreatePic($Ruta_ImagojoPro&"\Acercade.gif", 16, 24, 169, 153)
$Label1 = GUICtrlCreateLabel("ImagojoPro", 192, 24, 57, 17, $WS_GROUP)
$Label2 = GUICtrlCreateLabel("Version 1.01", 192, 48, 60, 17, $WS_GROUP)
...
$Pic1 = GUICtrlCreatePic($Ruta_ImagojoPro&"\ImagojoIco.gif", 262, 26, 33, 33)
...
$Button2=''
FileInstall ('C:\Imagojo\ImagojoEst\Estudios\Amsler.jpg', 'C:\ImagojoPro\Estudios\Amsler.jpg', 1)
$Form50 = GUICreate("ImagojoPro", 197, 165, 303, 219, -1, $WS_EX_TOPMOST)
...
$Label3 = GUICtrlCreateLabel($Nom_pa &" "&$Ape_pa, 8, 16, 119, 17)
GUISetState(@SW_SHOW)
#EndRegion ### END Koda GUI section ###
While 1
$nMsg = GUIGetMsg()
...
Case $Button1; Pasar Estudio
	...
	If $estudioSel='test de amsler'Then
		...
		MsgBox(0, "Atención", "Boton seleccionado el uno",10)
		Else
