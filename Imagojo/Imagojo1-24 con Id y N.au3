...
Global $ALIAS2BORRADA, $AE2, $IP2BORRADA, $PUERTO2, $ALIAS1, $AE1, $IP1, $PUERTO1, $OPSAL=1, $Debug=1
...
;	MsgBox(0, "Atención", $X_ventE&" Y="&$Y_ventE,10)
	...
	If $estudioSel='Test de Amsler'Then
		...
		$Button2 = GUICtrlCreateButton("Guardar y crear Dicom", 45, 80, 114, 25, 0)
		EndIf
	EndIf
...
Case $Button2; Crear Dicom
	...
	If $PID0 Then
		...
		if $t="20000101000000" Then 
			...
			$Button2 = GUICtrlCreateButton("Guardar y Crear Dicom", 256, 80, 81, 25, 0)
		Else
			GUIDelete ($form50)
			form5()
			Call ("Form1")
