...
Global $Pav=0, $arch_log, $Ocultar, $estudioSel="", $Consulta=0, $Nro_registros, $Nro_CONSULTA, $Query, $pat_id_issuer_Pacsdb='', $Op
...
Case $Button4;Visualizador Editor synedra View Personal
	...
	If ProcessExists("synedraViewPersonal.exe") Then 
		...
		Sleep (1000)
		If ProcessExists("synedraViewPersonal.exe") Then
		SplashTextOn ("Abrir Visor Editor", "Se incició proceso", 250,100)
		Sleep (1000)
		Else
