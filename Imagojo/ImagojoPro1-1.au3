...
; Programa ImagojoPro
; AutoIt 3.3.61
; Creado :12/11/10   Modificado: 14/08/11 
; Autores: Rodrigo Vlaeminck y Alvaro Prieto
;*********************************
;Tareas que faltan:
;Ver Weasis con navegador

If WinExists("ImagojoPro") Then
		WinActivate("ImagojoPro", "")
		MsgBox(0, "ATENCIÓN", "YA HAY UNA INSTANCIA DE ImagojoPro EJECUTÁNDOSE",5)
		Exit
		EndIf
#include <Date.au3>
#include <IE.au3>
...
;LECTURA DEL ARCHIVO DE CONFIGURACIÓN ImagojoPro.ini
...
$BorrarEnv=IniRead("ImagojoPro.ini", "EnvioDicom", "BorrarEnviados", '1')
$Ocultar=IniRead("C:\ImagojoPro\ImagojoPro.ini", "EnvioDicom", "Ocultar", '1')
$visorweb=IniRead("ImagojoPro.ini", "Navegador", "Visorweb", 'C:\ImagojoPro\GoogleChromePortable\GoogleChromePortable.exe')
$Estacion=IniRead("ImagojoPro.ini", "Estación", "Estación", 'Workstation')
...
DirCreate($Ruta_ImagojoPro&'\Lib\Gui')
DirCreate($Ruta_ImagojoPro&'\Estudios')
FileInstall ('C:\ImagojoProInst\Lib\ImagojoEnv.exe', $Ruta_ImagojoPro&'\Lib\ImagojoEnv.exe', 1)
FileInstall ('C:\ImagojoProInst\Lib\Gui\presentacion.jpg', $Ruta_ImagojoPro&'\Lib\Gui\presentacion.jpg', 1)
FileInstall ('C:\ImagojoProInst\Lib\Gui\barrita1.jpg', $Ruta_ImagojoPro&'\Lib\Gui\barrita1.jpg', 1)
FileInstall ('C:\ImagojoProInst\Lib\Gui\barrita2.jpg', $Ruta_ImagojoPro&'\Lib\Gui\barrita2.jpg', 1)
FileInstall ('C:\ImagojoProInst\Lib\Gui\bandacolorV.gif', $Ruta_ImagojoPro&'\Lib\Gui\bandacolorV.gif', 1)
FileInstall ('C:\ImagojoProInst\Lib\Gui\bandacolor.gif', $Ruta_ImagojoPro&'\Lib\Gui\bandacolor.gif', 1)
FileInstall ('C:\ImagojoProInst\Lib\Gui\mpgImage.jpg', $Ruta_ImagojoPro&'\Lib\Gui\mpgImage.jpg', 1)
FileInstall ('C:\ImagojoProInst\Lib\Gui\pdfImage.jpg', $Ruta_ImagojoPro&'\Lib\Gui\pdfImage.jpg', 1)
FileInstall ('C:\ImagojoProInst\Lib\Gui\acercade.gif', $Ruta_ImagojoPro&'\Lib\Gui\acercade.gif', 1)
FileInstall ('C:\ImagojoProInst\Lib\Gui\imagojoIco.gif', $Ruta_ImagojoPro&'\Lib\Gui\imagojoIco.gif', 1)
IniWrite($Ruta_ImagojoPro&"\ImagojoPro.ini", "EnvioDicom", "Ocultar", '1')
...
IniWrite($Ruta_ImagojoPro&"\ImagojoPro.ini", "Estación", "Estación", 'Workstation')
...
$Form0 = GUICreate("ImagojoPro - Inicio de sesión", 730, 440, $X_vent, $Y_vent)
GUISetBkColor(0xF9FCFF)
$Pic1 = GUICtrlCreatePic($Ruta_ImagojoPro&"\Lib\Gui\presentacion.jpg", 0, 0, 726, 243)
...
$ImagojoPro = GUICtrlCreateLabel("Sistema de Captura y Gestión de Imágenes Médicas", 100, 200, 300, 300)
GUICtrlSetFont(-1, 28, 400, 0, "MS Sans Serif")
GUISetState(@SW_SHOW)
#ce
...
;	if @error = 1 then Exit
		...
		ExitLoop
		Else
		MsgBox( 4096, "ATENCIÓN", "Contraseña no valida")
		$op=0
		exitloop
		Endif
;	WEnd	
...
If $EstadoServ = "Activo" Then $Pic1 = GUICtrlCreatePic($Ruta_ImagojoPro&"\Lib\Gui\bandacolorV.gif", 0, 0, 801, 40)
If $EstadoServ = "Inactivo" Then $Pic1 = GUICtrlCreatePic($Ruta_ImagojoPro&"\Lib\Gui\bandacolor.gif", 0, 0, 801, 40)
;$Pic2 = GUICtrlCreatePic($Ruta_ImagojoPro&"\Lib\Gui\barrita1.jpg", 0, 335, 801,110)
...
$MenuItem12 = GUICtrlCreateMenuItem("Enviar No Enviados", $MenuItem9)
...
Case $MenuItem12; Enviar NoEnviados
	$oculOrig=IniRead("C:\ImagojoPro\ImagojoPro.ini", "EnvioDicom", "Ocultar", '1')
	;Sleep (100)
	IniWrite($Ruta_ImagojoPro&"\ImagojoPro.ini", "EnvioDicom", "Ocultar", '0')
	;Sleep (100)
	RunWait($Ruta_ImagojoPro&'\Lib\ImagojoEnv.exe')
	;Sleep (2000)
	IniWrite($Ruta_ImagojoPro&"\ImagojoPro.ini", "EnvioDicom", "Ocultar", $oculOrig)
...
Case $MenuItem6;Borrar Enviados
            ...
            Else
                ...
                IniWrite($Ruta_ImagojoPro&"\ImagojoPro.ini", "EnvioDicom", "BorrarEnviados", '1')
            EndIf
...
$FormXX=$form5
;EnviarDcm()
Run($Ruta_ImagojoPro&'\Lib\ImagojoEnv.exe')
GUIDelete ($FormXX)
Call ("Form1")
...
SplashOff()
$Form6 = GUICreate("ImagojoPro Configuración", 801, 451, $X_vent, $Y_vent)
...
$Form8 = GUICreate("ImagojoPro Creación de Archivo Dicom a partir de:", 801, 451, $X_vent, $Y_vent)
GUISetBkColor(0xF9FCFF)
...
$Pic1 = GUICtrlCreatePic($Ruta_ImagojoPro&"\Lib\Gui\PdfImage.jpg", 136, 117, 249, 281)
...
$Pic1 = GUICtrlCreatePic($Ruta_ImagojoPro&"\Lib\Gui\MpgImage.jpg", 136, 117, 249, 281)
$Button1 = GUICtrlCreateButton("Crear", 432, 56, 75, 25, 0)
$Button2 = GUICtrlCreateButton("Cancelar", 16, 56, 75, 25, 0)
$Label1 = GUICtrlCreateLabel("Descripción del estudio", 8, 8, 114, 17)
...
$Image1 = GUICtrlCreatePic($Ruta_ImagojoPro&"\Lib\Gui\Acercade.gif", 16, 24, 169, 153)
...
$Pic1 = GUICtrlCreatePic($Ruta_ImagojoPro&"\Lib\Gui\ImagojoIco.gif", 262, 26, 33, 33)
...
$Button2=''
$paintEst=''
FileInstall ('C:\ImagojoProInst\Estudios\Amsler-dcm.jpg', 'C:\ImagojoPro\Estudios\Amsler.jpg', 1)
FileInstall ('C:\ImagojoProInst\Estudios\Farnsworth15-dcm.jpg', 'C:\ImagojoPro\Estudios\Farnsworth15.jpg', 1)
FileInstall ('C:\ImagojoProInst\Estudios\Farnsworth100-dcm.jpg', 'C:\ImagojoPro\Estudios\Farnsworth100.jpg', 1)
FileInstall ('C:\ImagojoProInst\Estudios\Goldman-dcm.jpg', 'C:\ImagojoPro\Estudios\Goldman.jpg', 1)
FileInstall ('C:\ImagojoProInst\Estudios\Munsell1-dcm.jpg', 'C:\ImagojoPro\Estudios\Munsell1.jpg', 1)
FileInstall ('C:\ImagojoProInst\Estudios\Munsell2-dcm.jpg', 'C:\ImagojoPro\Estudios\Munsell2.jpg', 1)
FileInstall ('C:\ImagojoProInst\Estudios\PantallaTGC-dcm.jpg', 'C:\ImagojoPro\Estudios\PantallaTGC.jpg', 1)
FileInstall ('C:\ImagojoProInst\Estudios\Pelli-Robinson-dcm.jpg', 'C:\ImagojoPro\Estudios\Pelli-Robinson.jpg', 1)
$Form50 = GUICreate("ImagojoPro", 197, 165, $X_ventE, $Y_ventE, -1, $WS_EX_TOPMOST)
$Label1 = GUICtrlCreateLabel("Estudio Seleccionado:", 16, 40, 110, 17)
$Combo1 = GUICtrlCreateCombo("", 16, 56, 169, 25)
GUICtrlSetData(-1, "Farnsworth 100|Farnsworth 15|Test de Amsler|1.Munsell separación|2.Munsell clasificación|Sensibilidad de constraste|Perimetría Goldman|Campo visual 2 ojos", "estudios")
GUISetState()
$Button1 = GUICtrlCreateButton("Pasar Estudio", 56, 80, 81, 25, 0)
...
;	MsgBox(0, "Atención", $X_ventE&" Y="&$Y_ventE,10)
	...
	If $estudioSel='Test de Amsler'Then
		...
		Else
		$Ruta_jpg = 'C:\ImagojoPro\Estudios\Amsler.jpg'
		Run ( 'mspaint.EXE "C:\ImagojoPro\Estudios\Amsler.jpg"' )
		GUICtrlDelete($Button1)
		GUICtrlDelete($Button2)
		$Button1 = GUICtrlCreateButton("Pasar Estudio", 256, 80, 81, 25, 0)
	...
	If $estudioSel='Farnsworth 100'Then
		...
		WinActivate($paintEst, "")
		Else
		$Ruta_jpg = 'C:\ImagojoPro\Estudios\Farnsworth100.jpg'
		Run ( 'mspaint.EXE "C:\ImagojoPro\Estudios\Farnsworth100.jpg"' )
		GUICtrlDelete($Button1)
		GUICtrlDelete($Button2)
		$Button1 = GUICtrlCreateButton("Pasar Estudio", 256, 80, 81, 25, 0)
		$Button2 = GUICtrlCreateButton("Crear Dicom", 56, 80, 81, 25, 0)
	...
	If $estudioSel='Farnsworth 15'Then
		...
		WinActivate($paintEst, "")
		Else
		$Ruta_jpg = 'C:\ImagojoPro\Estudios\Farnsworth15.jpg'
		Run ( 'mspaint.EXE "C:\ImagojoPro\Estudios\Farnsworth15.jpg"' )
		GUICtrlDelete($Button1)
		GUICtrlDelete($Button2)
		$Button1 = GUICtrlCreateButton("Pasar Estudio", 256, 80, 81, 25, 0)
		$Button2 = GUICtrlCreateButton("Crear Dicom", 56, 80, 81, 25, 0)
	...
	If $estudioSel='Perimetría Goldman'Then
		...
		WinActivate($paintEst, "")
		Else
		$Ruta_jpg = 'C:\ImagojoPro\Estudios\Goldman.jpg'
		Run ( 'mspaint.EXE "C:\ImagojoPro\Estudios\Goldman.jpg"' )
		GUICtrlDelete($Button1)
		GUICtrlDelete($Button2)
		$Button1 = GUICtrlCreateButton("Pasar Estudio", 256, 80, 81, 25, 0)
		$Button2 = GUICtrlCreateButton("Crear Dicom", 56, 80, 81, 25, 0)
	...
	If $estudioSel='1.Munsell separación'Then
		$paintEst="Munsell1 - Paint"
		If WinExists($paintEst) Then
		WinActivate($paintEst, "")
		Else
		$Ruta_jpg = 'C:\ImagojoPro\Estudios\Munsell1.jpg'
		Run ( 'mspaint.EXE "C:\ImagojoPro\Estudios\Munsell1.jpg"' )
		GUICtrlDelete($Button1)
		GUICtrlDelete($Button2)
		$Button1 = GUICtrlCreateButton("Pasar Estudio", 256, 80, 81, 25, 0)
		$Button2 = GUICtrlCreateButton("Crear Dicom", 56, 80, 81, 25, 0)
	...
	If $estudioSel='2.Munsell clasificación'Then
		$paintEst="Munsell2 - Paint"
		If WinExists($paintEst) Then
		WinActivate($paintEst, "")
		Else
		$Ruta_jpg = 'C:\ImagojoPro\Estudios\Munsell2.jpg'
		Run ( 'mspaint.EXE "C:\ImagojoPro\Estudios\Munsell2.jpg"' )
		GUICtrlDelete($Button1)
		GUICtrlDelete($Button2)
		$Button1 = GUICtrlCreateButton("Pasar Estudio", 256, 80, 81, 25, 0)
		$Button2 = GUICtrlCreateButton("Crear Dicom", 56, 80, 81, 25, 0)
	...
	If $estudioSel='Sensibilidad de constraste'Then
		...
		WinActivate($paintEst, "")
		Else
		$Ruta_jpg = 'C:\ImagojoPro\Estudios\Pelli-Robinson.jpg'
		Run ( 'mspaint.EXE "C:\ImagojoPro\Estudios\Pelli-Robinson.jpg"' )
		GUICtrlDelete($Button1)
		GUICtrlDelete($Button2)
		$Button1 = GUICtrlCreateButton("Pasar Estudio", 256, 80, 81, 25, 0)
		$Button2 = GUICtrlCreateButton("Crear Dicom", 56, 80, 81, 25, 0)
	...
	If $estudioSel='Campo visual 2 ojos'Then
		...
		WinActivate($paintEst, "")
		Else
		$Ruta_jpg = 'C:\ImagojoPro\Estudios\PantallaTGC.jpg'
		Run ( 'mspaint.EXE "C:\ImagojoPro\Estudios\PantallaTGC.jpg"' )
		GUICtrlDelete($Button1)
		GUICtrlDelete($Button2)
		$Button1 = GUICtrlCreateButton("Pasar Estudio", 256, 80, 81, 25, 0)
		$Button2 = GUICtrlCreateButton("Crear Dicom", 56, 80, 81, 25, 0)
...
Case $Button2; Crear Dicom
	...
	;If $PID0=0 Then MsgBox(0, "Atención", "Debe pasar estudio primero",10)
	If $PID0 Then
		WinClose($paintEst)
